...
\begin{subfigure}{0.32\textwidth}
    \includesvg[inkscapelatex=false, width=\linewidth]{Figures/chap4/tests/saved_2.5sec.svg}
    \caption{P-Frames \& Zeros}
...
\hfill
\begin{subfigure}{0.32\textwidth}
    \includesvg[inkscapelatex=false, width=\linewidth]{Figures/chap4/tests/saved_3sec.svg}
    \caption{P-Frames \& Zeros}
